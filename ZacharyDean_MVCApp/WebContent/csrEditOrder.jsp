...
<body>
	...
	<div class="main">
		...
		%>
			<form action="CSREditOrderProcessServlet" method="post">
				<table>
					<tr>
						<td>Shoe Size</td>
						<td>Quantity</td>
					...
					<table>
					<tr>
						<td colspan=4>Current Status: <%out.print(order.getStatus());%></td>
					</tr>
					<tr>
						<td>Keep Same <input type="radio" name="status" value="keep" checked></td>
						<td>Order Placed <input type="radio" name="status" value="Order Placed"></td>
						<td>In-Process <input type="radio" name="status" value="In Process"></td>
						<td>Delivered <input type="radio" name="status" value="Delivered"></td>
					</tr>
				</table>
				<table>
					<tr>
